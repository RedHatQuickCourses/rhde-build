...
--
...
include::1@samples:repos:example$rhel-92.json[lines=50..53]
...
include::1@samples:repos:example$rhel-92.json[lines=58..60]
...
--
+
...
+
Enter the btn:[Image Builder] item in Cockpit and click btn:[Sources]. Then, for both the btn:[BaseOS] and the btn:[AppStreams] channels, click btn:[>] to expand the URL and verify it matches your configuration overide.
+
