...
You sucessfully built an edge commit image and applied it as an update to a _test VM_, demonstrating that your new system image can upgrade edge devices.
