...
//TODO Steps 7a and 8a have an issue: timezone should be changed to America/Aruba, but it's back to UTC. Why?
...
7. Change configurations and application data on your _test VM_, so you can verify if those changes are retained by rolling back an update.
