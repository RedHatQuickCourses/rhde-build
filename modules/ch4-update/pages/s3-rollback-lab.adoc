...
.. Check that your _test VM_ still contains the changes to the system time zone and the PHP script, which doesn't work anymore because there's no PHP engine on its Apache Web Server.
+
[source,subs="verbatim,quotes"]
--
[core@microweb ~]$ *date*
