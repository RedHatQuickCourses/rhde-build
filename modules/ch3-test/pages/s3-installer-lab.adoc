...
.. Ensure that your bootable ISO is compatible with UEFI firmware and has a checksum for media checks. You will get a different MD5 checksum.
+
[source,subs="verbatim,quotes"]
--
...
$ *implantisomd5 new-installer.iso*
Inserting md5sum into iso image...
md5 = 0f4dbe4cf8235c24b29477d2acbbb943
Inserting fragment md5sums into iso image...
fragmd5 = 938f9cf2c2967feaa5944a8be971126197a684a278739579f68ff45f48c6
frags = 20
...
$ *cat temp-iso/osbuild.ks*
include::1@samples:ks:example$rhel9-mysql-installer.ks[lines=1..3]
...
$ *sudo umount temp-iso*
--
...
[source,subs="verbatim,quotes"]
--
$ *virt-install --name edge-db-1 --os-variant rhel9.2 --memory 4096 --vcpus 2 --disk size=20 \
